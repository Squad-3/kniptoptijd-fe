...
class Skeleton extends StatefulWidget {      //de hele pagina valt onder class KapperOverview
...
class _SkeletonState extends State<Skeleton> {              //Hier haalt flutter zijn content vandaan
  @override
